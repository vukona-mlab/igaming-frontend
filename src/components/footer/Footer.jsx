      ...
      <div className="container">
        ...
        <div className="w-full sm:w-1/3 mb-6">
          ...
          <ul className="space-y-2">
            <li>
              <ScrollLink to="home" smooth={true} duration={500} className="quick-link">
                Home
              </ScrollLink>
            </li>
            <li>
              <ScrollLink to="about" smooth={true} duration={500} className="quick-link">
                About
              </ScrollLink>
            </li>
            <li>
              <ScrollLink to="contact" smooth={true} duration={500} className="quick-link">
                Contact
              </ScrollLink>
            </li>
            <li>
              <ScrollLink to="profile" smooth={true} duration={500} className="quick-link">
                Profile
              </ScrollLink>
            </li>
            <li>
              <ScrollLink to="faq" smooth={true} duration={500} className="quick-link">
                FAQ
              </ScrollLink>
            </li>
            <li>
              <ScrollLink to="policy" smooth={true} duration={500} className="quick-link">
                Policy & Terms
              </ScrollLink>
            </li>
          </ul>
        ...
        <div className="w-full sm:w-1/3 subscribe-section">
          <h3 className="font-semibold text-lg mb-2">Subscribe to our community newsletter</h3>
          <input
            type="email"
